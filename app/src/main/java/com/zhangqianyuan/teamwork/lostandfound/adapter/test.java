...
import com.zhangqianyuan.teamwork.lostandfound.utils.RecyclerOnScrollerListener;
...
public class test extends RecyclerView.Adapter<test.ViewHolder> {
    ...
    public class FooterViewHolder extends test.ViewHolder{
    ...
    public test(List<DynamicItemBean> list, Activity activity) {
    ...
    public test.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final test.ViewHolder holder = new test.ViewHolder(view);
